...
namespace Nhom11_Quanlybangiay.Người_quản_lí
{
    public partial class frmNguoiquanli : Form
    {
        ...
        private void btnXemHD_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn chưa chọn một bản ghi nào!!!"); //XỬ LÍ LỖI
            }
            else
            {
                frmXemNhungHoaDonDaBanTheoNhanVien f = new frmXemNhungHoaDonDaBanTheoNhanVien(txtMa.Text);
                //BTN XEM HÓA ĐƠN ĐÃ BÁN THEO NHÂN VIÊN
                f.Show();
            }
        }
